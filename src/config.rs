...
pub const LINK_DOCS_HOME: &str = "https://www.0vk.com";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.0vk.com"];
pub const RS_PUB_KEY: &str = "137858006";

pub const RENDEZVOUS_PORT: i32 = 21116;
pub const RELAY_PORT: i32 = 22222;
